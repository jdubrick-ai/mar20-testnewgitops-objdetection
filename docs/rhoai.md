...
3) Access the `workbench` named `mar20-testnewgitops-objdetection-notebook`.
...
5) In the terminal, run `cd mar20-testnewgitops-objdetection` to navigate to your sample app's directory.
